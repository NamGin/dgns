    ...
    <div class="<?= $isNewForm ? '' : 'print:block' ?>">
        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                <td class="border border-gray-300 p-2 text-center font-bold"><?= $evaluation['extra_deduction'] ?? 0 ?></td>
                <td></td>
                </tr>
                <tr>
...
<?php endif; ?>
        ...
        <?php if (!$isNewForm): ?>
<form method="post" action="<?= $GLOBALS['config']['base_url'] ?>evaluation/update-extra-deduction" class="mt-4 flex items-center gap-2 print:hidden">
    <input type="hidden" name="evaluation_id" value="<?= $evaluation['id'] ?>">
    <label for="extra_deduction"><b>Số điểm bị trừ bổ sung (nếu có):</b></label>
    <input type="number" name="extra_deduction" id="extra_deduction" value="<?= $evaluation['extra_deduction'] ?? 0 ?>" min="0" style="width:80px;">
