...
<div class="bg-white rounded-lg shadow-md p-6 print:shadow-none print:p-0">
    ...
    <div class="flex justify-between items-center mb-4 print:hidden">
        <h2 class="text-xl font-bold text-gray-800">
            <?= $isNewForm ? ($isManager ? 'Tạo đánh giá lãnh đạo' : 'Tạo đánh giá chuyên viên') : 'Chi tiết đánh giá - Phó Giám đốc' ?>
        </h2>
        <div>
            <?php if (!$isNewForm): ?>
...
<p>Điểm thực hiện chức trách, nhiệm vụ (phần II): <?= $dutyScore ?></p>
    ...
    <div class="mt-8 print:hidden">
        ...
        <?php if($reviewType === 'deputy_director'): ?>
        <form method="POST" action="<?= $GLOBALS['config']['base_url'] ?>pho-giam-doc-xem/submit/<?= $evaluation['id'] ?>">
        <?php else: ?>
